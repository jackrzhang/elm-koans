        ...
        , test "or from a list of key-value pairs" <|
            \() ->
                2
                    ...
                    -- Dict.fromList, <function> : List ( comparable, v ) -> Dict.Dict comparable v
        ...
        , test "a key-value pair can be added to the dictionary" <|
            \() ->
                (Just "b")
                    ...
                    -- Dict.singleton, <function> : comparable -> v -> Dict.Dict.comparable v
                    -- Dict.insert, <function> : comparable -> v -> Dict.Dict comparable v -> Dict.Dict comparable v
                    -- Dict.get, <function> : comparable -> Dict.Dict comparable v -> Maybe.Maybe v
        ...
        , test "updating a value works similarly" <|
            \() ->
                (Just "b")
                    ...
                    -- Dict.update, <function> : comparable -> (v -> Maybe.Maybe v) -> Dict.Dict comparable v -> Dict.Dict comparable v
        ...
        , test "mapping works similarly as with lists" <|
            ...
            \() ->
                [ "ac", "bc" ]
                    ...
                    -- Dict.map, <function> : (comparable -> v -> v) -> Dict.Dict comparable v -> Dict.Dict comparable v
        ]
